...
CRITICAL_FILES = [
    ...
    Path("frontend/src/routes/AdminPageRenderer.jsx"),
    Path("frontend/src/components/admin/UserDetailPanel.jsx"),
    Path("frontend/src/components/admin/UserForm.jsx"),
    Path("frontend/src/components/admin/OrganizationDetailPanel.jsx"),
    Path("frontend/src/components/admin/OrganizationForm.jsx"),
    Path("frontend/src/components/admin/RoleDetailPanel.jsx"),
...
REQUIRED_BY_FILE = {
    ...
    Path("frontend/src/pages/AdminCoursesPage.jsx"): [
        "const RU =",
        "COURSE_ACTIVE_FILTERS",
        "AdminQuickFilterButtons",
        "buildCoursesPath",
        r"\u041f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u044b \u043e\u0431\u0443\u0447\u0435\u043d\u0438\u044f",
        r"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u043f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u0443",
