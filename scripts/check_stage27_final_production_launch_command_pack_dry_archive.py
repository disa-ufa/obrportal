...
DOC_PATH = ROOT / "docs" / "stage-27-final-production-launch-command-pack-dry-archive.md"
...
def main() -> None:
    ...
    require_markers(doc_text, DOC_MARKERS, "stage 27 doc")
    ...
    require_no_forbidden_secret_values(doc_text, "stage 27 doc")
    require_no_forbidden_secret_values(read_text(ROOT / ".env.example"), ".env.example")
    require_env_ignored_if_exists()

    print(
        "stage 27 final production launch command pack dry archive diagnostics passed: "
