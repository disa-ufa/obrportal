...
REQUIRED_MARKERS = [
    ...
    "Stage 12.1 account UX polish tag docs sync - 2026-05-27",
    "Stage 12.1 account UX polish checkpoint tag - 2026-05-27",
    "stage12_1_account_card_visuals_guard_sync=passed",
    "production git head: 3d5da81",
    "Stage 12.1 account card visuals guard sync - 2026-05-27",
    ...
    "Stage 12.1 account card visuals frontend deploy - 2026-05-27",
