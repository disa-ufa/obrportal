...
def main() -> None:
    ...
    require_contains(
        ...
        [
            ...
            "function buildEnrollmentSortKey",
            ...
            "function buildOrganizationUserSortKey",
            "normalizeObject(user)",
