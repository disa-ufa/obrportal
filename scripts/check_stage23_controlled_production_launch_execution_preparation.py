...
DOC_PATH = ROOT / "docs" / "stage-23-controlled-production-launch-execution-preparation.md"
...
def main() -> None:
    ...
    require_markers(doc_text, DOC_MARKERS, "stage 23 doc")
    ...
    require_no_forbidden_secret_values(doc_text, "stage 23 doc")
    require_no_forbidden_secret_values(read_text(ROOT / ".env.example"), ".env.example")
    require_env_ignored_if_exists()

    print(
        "stage 23 controlled production launch execution preparation diagnostics passed: "
