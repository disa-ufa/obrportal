...
def require_manifest_stage() -> None:
    ...
    if current_stage not in {"78.1", "78.2", "78.3", "78.4", "78.5", "78.6", "78.7", "78.8", "78.9", "79.1", "79.2", "79.3"}:
    ...
    if status not in {"implementation_ready", "production_deployed", "79.1", "79.2", "79.3"}:
