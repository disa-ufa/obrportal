...
def main() -> None:
    require_contains(
        ...
        [
            ...
            "replaceOrgProfileRecipientCategories,",
            ...
            "handleSaveOrganizationRecipientCategories",
    ...
    require_contains(
        ...
        [
            ...
            "Контактные данные",
            "organization-profile-accessibility-editor",
            "organization-profile-accessibility",
            "Доступность среды",
            "Статус доступности",
    ...
    require_contains(
        ...
        [
            ...
            "organization-profile-recipient-categories",
            "Категории получателей услуг",
            "Редактировать категории",
            "Добавить категорию",
            "Сохранить категории",
            "buildOrganizationProfileRecipientCategoriesFormData",
            "validateRecipientCategories",
            "Можно указать не более 100 категорий получателей услуг",
            "персональные",
        ],
    )
    ...
    require_contains(
        ...
        [
            ...
            "/api/v1/org/profile/${organizationId}/recipient-categories",
