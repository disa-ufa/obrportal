...
DOC_PATH = ROOT / "docs" / "stage-20-final-release-candidate-launch-checklist.md"
...
def main() -> None:
    ...
    require_markers(doc_text, DOC_MARKERS, "stage 20 doc")
    ...
    require_no_forbidden_secret_values(doc_text, "stage 20 doc")
    require_no_forbidden_secret_values(read_text(ROOT / ".env.example"), ".env.example")
    require_env_ignored_if_exists()

    print(
        "stage 20 final release candidate/launch checklist diagnostics passed: "
