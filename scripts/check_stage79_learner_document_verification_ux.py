...
def require_manifest() -> None:
    ...
    if manifest.get("current_stage") not in {"79.4", "79.5", "79.6", "80.1", "80.2", "80.3", "80.4"}:
    ...
    if stage79_4.get("status") not in {"implementation_ready", "production_deployed", "79.6", "80.1", "80.2", "80.3", "80.4"}:
