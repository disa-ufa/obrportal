...
DOC = Path("docs/stage72-production-deployment-execution-result.md")
...
def main() -> int:
    ...
    if missing:
        print("Stage 72.40 production deployment execution result guard failed. Missing markers:")
        for marker in missing:
            print(f" - {marker}")
        return 1

    print("Stage 72.40 production deployment execution result guard: passed")
    return 0
