...
DOC = Path("docs/stage72-production-backup-before-deploy-execution-preparation-acceptance.md")
...
def main() -> int:
    ...
    if missing:
        print("Stage 72.27 production backup-before-deploy execution preparation acceptance guard failed. Missing markers:")
        for marker in missing:
            print(f" - {marker}")
        return 1

    print("Stage 72.27 production backup-before-deploy execution preparation acceptance guard: passed")
    return 0
