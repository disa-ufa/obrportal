...
DOC = Path("docs/stage72-production-post-deploy-manual-smoke-result.md")
...
def main() -> int:
    ...
    if missing:
        print("Stage 72.44 production post-deploy manual smoke result guard failed. Missing markers:")
        for marker in missing:
            print(f" - {marker}")
        return 1

    print("Stage 72.44 production post-deploy manual smoke result guard: passed")
    return 0
