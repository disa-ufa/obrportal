...
DOC_PATH = ROOT / "docs" / "stage-25-final-project-closure-handoff-package.md"
...
def main() -> None:
    ...
    stage21_text = read_text(STAGE21_DOC_PATH)
    stage22_text = read_text(STAGE22_DOC_PATH)
    stage23_text = read_text(STAGE23_DOC_PATH)
    stage24_text = read_text(STAGE24_DOC_PATH)

    require_markers(doc_text, DOC_MARKERS, "stage 25 doc")
    ...
    require_markers(stage21_text, STAGE21_MARKERS, "stage 21 doc")
    require_markers(stage22_text, STAGE22_MARKERS, "stage 22 doc")
    require_markers(stage23_text, STAGE23_MARKERS, "stage 23 doc")
    require_markers(stage24_text, STAGE24_MARKERS, "stage 24 doc")

    require_no_forbidden_secret_values(doc_text, "stage 25 doc")
    require_no_forbidden_secret_values(read_text(ROOT / ".env.example"), ".env.example")
    require_env_ignored_if_exists()

    print(
        "stage 25 final project closure/handoff package diagnostics passed: "
