...
DOC = Path("docs/stage72-production-release-closure-summary.md")
...
def main() -> int:
    ...
    if missing:
        print("Stage 72.48 production release closure summary guard failed. Missing markers:")
        for marker in missing:
            print(f" - {marker}")
        return 1

    print("Stage 72.48 production release closure summary guard: passed")
    return 0
