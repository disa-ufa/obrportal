...
def main() -> None:
    ...
    if checkpoint.get("last_confirmed_stage") != "82.6":
        fail("last_confirmed_stage must be 82.6")
    if checkpoint.get("last_confirmed_head") != "eed8ae9":
        fail("last_confirmed_head must be eed8ae9")
    if checkpoint.get("last_confirmed_tag") != "v0.1.0-stage82-6-lesson-block-editor-ux":
    ...
    if checkpoint.get("status") != "lesson_block_editor_ux_deployed":
        fail("checkpoint status mismatch")
    if checkpoint.get("decision") != "continue_with_lesson_block_viewer":
    ...
    for stage_id in ["80.4", "80.5", "81.1", "81.2", "81.3", "81.4", "81.5", "81.6", "81.7", "81.8", "81.9", "81.10", "81.11", "81.12", "81.13", "81.14", "81.15", "82.1", "82.2", "82.3", "82.4", "82.5", "82.6", "82.7"]:
