...
DOC_PATH = ROOT / "docs" / "stage-30-final-pre-launch-freeze-release-archive-closure.md"
...
STAGE28_DOC_PATH = ROOT / "docs" / "stage-28-final-release-ledger-tag-registry-archive.md"
STAGE29_DOC_PATH = ROOT / "docs" / "stage-29-final-operator-delivery-bundle-archive.md"
...
REQUIRED_FILES = [
    ...
    ROOT / "scripts" / "check_stage28_final_release_ledger_tag_registry_archive.py",
    ROOT / "scripts" / "check_stage29_final_operator_delivery_bundle_archive.py",
...
STAGE28_MARKERS = [
    "Stage 28.3 final release ledger acceptance",
    "stage28_final_release_ledger_accepted=yes",
    "stage28_real_launch_executed_no=yes",
]

STAGE29_MARKERS = [
    "Stage 29.3 final operator delivery acceptance",
...
def main() -> None:
    ...
    require_markers(doc_text, DOC_MARKERS, "stage 30 doc")
    ...
    require_markers(read_text(STAGE28_DOC_PATH), STAGE28_MARKERS, "stage 28 doc")
    require_markers(read_text(STAGE29_DOC_PATH), STAGE29_MARKERS, "stage 29 doc")

    require_no_forbidden_secret_values(doc_text, "stage 30 doc")
    require_no_forbidden_secret_values(read_text(ROOT / ".env.example"), ".env.example")
    require_env_ignored_if_exists()

    print(
        "stage 30 final pre-launch freeze release archive closure diagnostics passed: "
