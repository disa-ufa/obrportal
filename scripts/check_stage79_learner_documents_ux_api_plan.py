...
def require_manifest() -> None:
    ...
    if manifest.get("current_stage") not in {"79.2", "79.3", "79.4", "79.5", "79.6", "80.1", "80.2"}:
    ...
    if stage79_2.get("status") not in {"implementation_ready", "production_confirmed", "79.4", "79.5", "79.6", "80.1", "80.2"}:
