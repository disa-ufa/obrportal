...
DOC = Path("docs/stage72-production-deployment-execution-result-audit.md")
...
def main() -> int:
    ...
    if missing:
        print("Stage 72.41 production deployment execution result audit guard failed. Missing markers:")
        for marker in missing:
            print(f" - {marker}")
        return 1

    print("Stage 72.41 production deployment execution result audit guard: passed")
    return 0
