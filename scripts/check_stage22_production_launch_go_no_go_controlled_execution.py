...
DOC_PATH = ROOT / "docs" / "stage-22-production-launch-go-no-go-controlled-execution.md"
...
def main() -> None:
    ...
    require_markers(doc_text, DOC_MARKERS, "stage 22 doc")
    ...
    require_no_forbidden_secret_values(doc_text, "stage 22 doc")
    require_no_forbidden_secret_values(read_text(ROOT / ".env.example"), ".env.example")
    require_env_ignored_if_exists()

    print(
        "stage 22 production launch go/no-go controlled execution diagnostics passed: "
