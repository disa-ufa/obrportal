...
def main() -> None:
    require_contains(
        "frontend/src/pages/LearnerImportsPage.jsx",
        [
            "function getPreflightClassificationLabel(",
            "function getPreflightClassificationTone(",
            "function getPreflightRowActionSummary(",
            "function PreflightClassificationPill(",
            "selectedImport?.preflight",
            "selectedPreflightRowsByKey",
            "learner-import-preflight-card",
            "learner-import-preflight-summary",
            "learner-import-preflight-attention-count",
            "learner-import-apply-result-card",
            "learner-import-preflight-row-decision",
            "selectedPreflight.new_users_count",
            "selectedPreflight.existing_inactive_users_count",
            "selectedPreflight.existing_active_users_count",
            "selectedPreflight.existing_enrollments_count",
            "selectedPreflight.identity_conflicts_count",
            "selectedPreflight.new_profiles_count",
            "selectedPreflight.updated_profiles_count",
            "selectedPreflight.new_enrollments_count",
            "selectedPreflight.password_setup_invitations_count",
            "selectedPreflight.new_course_notifications_count",
            "const courseNotificationCount = Array.isArray(applied.course_notifications)",
            "selectedImport.course_notifications?.length",
            "learner-import-course-notifications-card",
            "selectedImport.course_notifications.map",
