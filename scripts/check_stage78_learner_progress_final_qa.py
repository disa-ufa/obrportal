...
def require_manifest() -> dict:
    ...
    if manifest.get("current_stage") not in {"78.9", "79.1", "79.2", "79.3", "79.4", "79.5", "79.6", "80.1", "80.2", "80.3"}:
    ...
    if stage78_9.get("status") not in {"implementation_ready", "production_confirmed", "79.2", "79.3", "79.4", "79.5", "79.6", "80.1", "80.2", "80.3"}:
