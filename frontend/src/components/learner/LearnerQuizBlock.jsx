...
import LessonQuizQuestionView from "../lesson/LessonQuizQuestionView";
import { LessonQuizQuestionCard, LessonQuizShell } from "../lesson/LessonQuizQuestionView";
...
export function LearnerQuizBlock({
  ...
  return (
    <LessonQuizShell
      testId="learner-quiz-block"
      title={quiz?.title || block?.title || "\u0422\u0435\u0441\u0442"}
        ...
        {questions.map((question, index) => {
          ...
          return (
            <LessonQuizQuestionCard
              ...
              question={question}
              index={index}
              showPoints={ui.show_question_points !== false}
              testId="learner-quiz-question"
            >
