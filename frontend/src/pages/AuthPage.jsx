        ...
        <div className="space-y-4 text-sm leading-6 text-slate-600">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <div className="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200">
              ...
              <div className="mt-1">Каталог, регистрация, покупка курса, обучение и документы.</div>
            </div>
            <div className="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200">
              <div className="font-semibold text-slate-900">Для back-office</div>
              <div className="mt-1">RBAC, 2FA и перевод в рабочий административный контур.</div>
            </div>
          </div>
